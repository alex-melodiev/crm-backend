...
module.exports = {
  ...
  /**
   * Add relation to a/an service record.
   *
   * @return {Object}
   */

  createRelation: async (ctx, next) => {
    return strapi.services.service.addRelation(ctx.params, ctx.request.body);
  },

  /**
   * Update relation to a/an service record.
   *
   * @return {Object}
   */

  updateRelation: async (ctx, next) => {
    return strapi.services.service.editRelation(ctx.params, ctx.request.body);
  },

  /**
   * Destroy relation to a/an service record.
   *
   * @return {Object}
   */

  destroyRelation: async (ctx, next) => {
    return strapi.services.service.removeRelation(ctx.params, ctx.request.body);
  }
};
